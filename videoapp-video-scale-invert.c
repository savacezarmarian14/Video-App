...
int main(int argc, char **argv)
{
    ...
    gst_bin_add_many(GST_BIN(pipeline), src, capsfilter, convert, scaler, capsScaler, invertorConverter, invertor, screen, NULL);

    gRet = gst_element_link_many(src, capsfilter, convert, scaler, capsScaler, invertor, invertorConverter, screen, NULL);
    if (FALSE == gRet) {
